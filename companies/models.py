...
class Company(models.Model):
    ...
    cuit = models.CharField(max_length=11, verbose_name="CUIT", default="")
    activity_code = models.CharField(max_length=2, verbose_name="Código de Actividad")
    ...
    dept = models.CharField(max_length=100, verbose_name="Departamento", blank=True, null=True)
    city = models.ForeignKey(City, verbose_name="Localidad", on_delete=models.DO_NOTHING, blank=True, null=True)
    zip_code = models.IntegerField(verbose_name="Código Postal", blank=True, null=True)
